...
test('/app loads EventBus before bootstrap and does not install the retired Supabase fetch bridge',()=>{
  const app=read('app/index.html');
  const eventBus=app.indexOf('/eventbus-runtime.js');
  const bootstrap=app.indexOf('/src/bootstrap.js');
  assert.equal(app.indexOf('/src/cloudflare-fetch-bridge.js'),-1);
